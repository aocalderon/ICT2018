...
train_set = pd.read_csv('H:/mnist/train.csv')
# extract the labels:
...
keras.initializers.TruncatedNormal(mean=0.0, stddev=0.05, seed=42)
model.compile(optimizer='rmsprop', loss='categorical_crossentropy', metrics=['accuracy'])

#%%
# Training
history = model.fit(data, encoded_label, validation_split=0.1,  batch_size=64, epochs=8, verbose=1)
...
#%%
# Load the test set:
test_set = pd.read_csv('H:/mnist/test.csv')
# test features:
