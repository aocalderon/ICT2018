...
parser.add_argument("--suffix", default="intermediate2_", type=str, help='Suffix of saved image')
...
suffix = "{0}_({1}x)".format(args.suffix, args.scale)
...
print("model={} mode={}".format(model_type, mode))
